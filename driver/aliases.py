...
ALIASES["beauty"] = ["--search", "beauty(single(estimated_g()), verbosity=silent)"]

ALIASES["any-beauty"] = ["--search", "anytime_beauty([beauty(single(estimated_g()), verbosity=silent)])"]

ALIASES["any-beauty-verbose"] = ["--search", "anytime_beauty([beauty(single(estimated_g()))])"]

ALIASES["EI-UCS"] = ["--search", "anytime_beauty([beauty(single(estimated_g()), verbosity=silent)], max_iter=1)"]

ALIASES["any-beauty-2"] = ["--search", "anytime_beauty([beauty(single(estimated_g()), verbosity=silent)], max_iter=2)"]

ALIASES["any-beauty-3"] = ["--search", "anytime_beauty([beauty(single(estimated_g()), verbosity=silent)], max_iter=3)"]

ALIASES["any-beauty-4"] = ["--search", "anytime_beauty([beauty(single(estimated_g()), verbosity=silent)], max_iter=4)"]

ALIASES["any-beauty-5"] = ["--search", "anytime_beauty([beauty(single(estimated_g()), verbosity=silent)], max_iter=5)"]
