...
fast_downward_plugin(
    NAME ESTIMATED_G_EVALUATOR
    HELP "The estimated g-evaluator"
    SOURCES
        evaluators/estimated_g_evaluator
    DEPENDS EVALUATORS_PLUGIN_GROUP
)
...
fast_downward_plugin(
    ...
    DEPENDS ALTERNATION_OPEN_LIST ESTIMATED_G_EVALUATOR G_EVALUATOR BEST_FIRST_OPEN_LIST SUM_EVALUATOR TIEBREAKING_OPEN_LIST WEIGHTED_EVALUATOR
    DEPENDENCY_ONLY
)
...
fast_downward_plugin(
    NAME ANYTIME_BEAUTY
    HELP "Anytime beauty edge-cost estimation search algorithm"
    SOURCES
        search_engines/anytime_beauty
)

fast_downward_plugin(
   NAME BEAUTY
   HELP "Beauty edge-cost estimation search algorithm"
   SOURCES
       search_engines/beauty
   DEPENDS NULL_PRUNING_METHOD ORDERED_SET SUCCESSOR_GENERATOR
)

fast_downward_plugin(
    NAME PLUGIN_BEAUTY
    HELP "Beauty edge-cost estimation best-first search"
    SOURCES
        search_engines/plugin_beauty
    DEPENDS BEAUTY SEARCH_COMMON
)

fast_downward_plugin(
    NAME ITERATED_SYNC
    HELP "Iterated synchronic edge-cost estimation search algorithm"
    SOURCES
        search_engines/iterated_sync
)

fast_downward_plugin(
   NAME SYNCHRONIC_ESTIMATION_SEARCH
   HELP "Synchronic edge-cost estimation search algorithm"
   SOURCES
       search_engines/synchronic_estimation_search
   DEPENDS NULL_PRUNING_METHOD ORDERED_SET SUCCESSOR_GENERATOR
)

fast_downward_plugin(
    NAME PLUGIN_SYNCHRONIC_ESTIMATION
    HELP "Synchronic edge-cost estimation best-first search"
    SOURCES
        search_engines/plugin_synchronic_estimation
    DEPENDS SYNCHRONIC_ESTIMATION_SEARCH SEARCH_COMMON
)
