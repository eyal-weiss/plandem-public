...
public:
    ...
    void set_target_epsilon(double target) {target_epsilon = target;}
    void set_l_est(int l_est_new) {l_est = l_est_new;}
    void set_l_prune(int l_prune_new) {l_prune = l_prune_new;}
    double get_uncertainty_ratio() {return uncertainty_ratio;}
    bool get_opt() {return opt;}
    int get_l_low() {return l_low;}
    int get_l_high() {return l_high;}
