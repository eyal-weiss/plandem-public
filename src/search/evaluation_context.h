...
public:
    ...
    */
    EvaluationContext(
        ...
        bool calculate_preferred = false, EstimationInfo *g_estimation_ptr = nullptr);
    /*
    ...
    */
    EvaluationContext(
        ...
        EstimationInfo *g_estimation_ptr = nullptr);
    /*
    ...
    */
    ...
    const EstimationInfo &get_estimation_info();
